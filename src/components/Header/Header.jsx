                    ...
                    <Link to="/" className="flex flex-wrap items-center">
                        ...
                        <ul className="flex flex-wrap items-center mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0 justify-center ">
                            <li>
                                ...
                                to=""
                                    className={({isActive}) =>
                                        `block py-2 pr-4 pl-3 duration-200 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:p-0 ${isActive ? "text-orange-700" : "text-gray-700"}  hover:text-orange-700`
                                    }
                                >
                                    Home
                                </NavLink>
